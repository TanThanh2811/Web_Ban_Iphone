...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO iphone_used (tenSP, moTa, giaBan, soLuong, tinhTrang, hinhAnh, dungLuong, doMoi, pin)
            VALUES ('$ten', '$moTa', '$gia', '$soLuong', '$tinhTrang', '$hinhAnh', '$dungLuong', '$doMoi', '$pin')";
